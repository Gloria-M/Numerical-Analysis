...
% Grupa 344
% -------------------------------------------------------------------------
% Ex_8aSecantei.m - Fisier 'script'
% -------------------------------------------------------------------------
%
% Fisier pentru plotarea graficului functiei pe intervalul ales si a
% solutiilor gasite prin Metoda Secantei
%
...
fGraf = figure('Name', 'Metoda Secantei', 'NumberTitle', 'off');
...
set (axaOx, 'LineStyle', ':', 'LineWidth', 0.5, 'Color', wesColors(8, :));
set (aproximari, 'Marker', 'o', 'MarkerFaceColor', wesColors(8, :), ...
